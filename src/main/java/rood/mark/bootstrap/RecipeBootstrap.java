package rood.mark.bootstrap;

import rood.mark.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.getCatagories().add(americanCategory);
        guacRecipe.getCatagories().add(mexicanCategory);
        ...
        tacosRecipe.getCatagories().add(americanCategory);
        tacosRecipe.getCatagories().add(mexicanCategory);
